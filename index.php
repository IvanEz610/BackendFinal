        ...
        <div id="blog-carousel" class="carousel slide overlay-bottom" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/panescarrusel.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h2 class="text-primary font-weight-medium m-0">Nosotros hemos estando creando</h2>
                        <h1 class="display-1 text-white m-0">PANES</h1>
                        <h2 class="text-white m-0">* DESDE 2007 *</h2>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="section-title">
                ...
                <h1 class="display-4">Creando desde 2007</h1>
            </div>
            <div class="row">
                <div class="col-lg-4 py-0 py-lg-5">
                    <h1 class="mb-3">Nuestra historia</h1>
                    <h5 class="mb-3">Fundada hace casi de dos décadas, nuestra panadería y confitería nace del esfuerzo constante y la pasión por la calidad artesanal</h5>
                    <p>Ubicada en el corazón de la ciudad, se distingue por el compromiso absoluto con la excelencia. Cada producto, elaborado con ingredientes frescos y técnicas tradicionales, refleja verdadera dedicación e innovación, ofreciendo una experiencia única y un servicio impecable a cada cliente verdaderamente exigente.</p>
                    <a href="" class="btn btn-secondary font-weight-bold py-2 px-4 mt-2">Leer más</a>
                </div>
                <div class="col-lg-4 py-5 py-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="img/sobre.png" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-4 py-0 py-lg-5">
                    <h1 class="mb-3">Nuestra Visión</h1>
                    <p>Nuestra visión es ser un referente en calidad y tradición en panadería y confitería. Innovamos promoviendo sostenibilidad y satisfacción del cliente. Buscamos crecer manteniendo la pasión por la excelencia artesanal y creando productos que celebren momentos especiales con sabor, dedicación y servicio excepcional.</p>
                    <h5 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>Calidad</h5>
                    <h5 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>Sabor</h5>
                    <h5 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>Deleite</h5>
